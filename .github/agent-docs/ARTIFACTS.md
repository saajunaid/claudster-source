...
| 2026-02-19 | Architect | ADR | Chat widget architecture — Option B (micro-frontend hybrid) | `docs/architecture/ADR-chat-widget-architecture.md` | current | approved | FEAT-2026-0219-track-a-chat-widget |
